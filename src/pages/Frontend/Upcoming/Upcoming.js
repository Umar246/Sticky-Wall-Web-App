...
let uoComingTodos = fetchTodos.filter((todoFromFirebase)=> todoFromFirebase.date > todayDate)
    ...
    <>
      <div className="py-2">
        <div className="container">
          ...
          <div className="row">
            <div className="col">
              <h2>Upcoming <sup className='text-primary' style={{ fontSize: '20px', }}>({uoComingTodos.length})</sup> </h2>
            </div>
          </div>
